...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
        ...
        "
        >
            <div className="relative w-full lg:w-3/4 my-6 mx-auto lg:max-w-xl h-full lg:h-auto
            "
            >
                {/* Content */}
                <div className="h-full lg:h-auto border-b rounded-lg shadow-lg relative flex flex-col
